...
7. Report the actual result, source method, audience, period, inventory count and limitations. `no_data` means unavailable under that methodology, not zero. Do not infer support for New OTS from a nonzero inventory-ranking OTS value.
