...
Measurements from 6 September 2026, using the METER API directly: Tashkent, three surfaces, 1–31 August 2026, audience ages 6–100. These are API response times including reading/parsing the response, not assistant task completion times or an SLA. OAuth, authorization and remote MCP transport were outside this benchmark. No customer identifiers or calculation payloads are included here.
